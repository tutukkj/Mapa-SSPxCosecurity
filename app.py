...
zonas_sao_paulo = {
    'Zona Central': ['Bela Vista', 'Bom Retiro', 'Cambuci', 'Consolação', 'Liberdade', 'República', 'Sé'],
    'Zona Norte': ['Brasilândia', 'Cachoeirinha', 'Jaçanã', 'Limão', 'Mandaqui', 'Santana', 'Tremembé', 'Tucuruvi', 'Vila Maria', 'Vila Guilherme'],
    'Zona Leste': ['Água Rasa', 'Aricanduva', 'Artur Alvim', 'Cidade Tiradentes', 'Guaianases', 'Itaim Paulista', 'Itaquera', 'Parque Do Carmo', 'Penha', 'São Miguel Paulista'],
    'Zona Oeste': ['Butantã', 'Jaguaré', 'Lapa', 'Pinheiros', 'Perdizes', 'Pirituba', 'Rio Pequeno', 'Vila Leopoldina'],
    'Zona Sul': ['Campo Belo', 'Campo Limpo', 'Capão Redondo', 'Cidade Ademar', 'Grajaú', 'Ipiranga', 'Jabaquara', 'Moema', 'Morumbi', 'Santo Amaro']
}
